:warning: This is a fork of https://github.com/BitcoinRaven/Bitcoin-Risk-Metric-V2. It contains small updates that fix the tool after some changes to the API. You must add your own Quandl API Key.
